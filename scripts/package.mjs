...
zip(sourceZip, ["src", "tests", "scripts", "public", ".github", "docs", "loader", "dist", "README.md", "LICENSE", ".gitignore", "package.json", "package-lock.json", "tsconfig.json", "vite.config.ts", "vitest.config.ts"]);
